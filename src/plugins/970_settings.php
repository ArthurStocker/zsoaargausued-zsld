...
<span id="nav-container-settings">
    ...
    <button id="nav-item-settings" type="button" class="btn btn-primary btn-lg modal-btn" data-toggle="modal" data-target="#modal-settings">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-success" data-dismiss="modal">Speichern</button>
                    </div>
                </div>
