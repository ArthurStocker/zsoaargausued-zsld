...
<span id="nav-container-layer">
    ...
    <button id="nav-item-layer" type="button" class="btn btn-primary btn-lg modal-btn" data-toggle="modal" data-target="#modal-layer">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-warning" data-dismiss="modal" onclick="Plugins.layer.ResetLayers()">Karte zurücksetzen</button>
                    </div>
                </div>
