...
<span id="nav-container-query">
    ...
    <button id="nav-item-query" type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modal-query">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="query-container" ga-query class="form-horizontal collapse in" aria-expanded="true" style="">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick=execQuery()>Query</button>
                </div>
