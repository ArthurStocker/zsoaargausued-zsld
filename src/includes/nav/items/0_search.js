  ...
  if (originZoom.hasOwnProperty(origin)) {
    ...
    $http = new Rest(
      function(data) {
        ...
        data.features[0].properties.description = '<b>Koordinaten</b></br>x: ' + location.attrs.x + '</br>y: ' + location.attrs.y + '</br></br></br><a class="data-link" href="data:application/octet-stream;charset=utf-8,' + uri + '" download="standort.csv">Als CSV herunterladen</a>';
    ...
    $http.get(getUrl('feature-yha-url'));
